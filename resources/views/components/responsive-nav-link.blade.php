...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-red-500 text-left text-base font-medium text-black bg-red-50 focus:outline-none focus:bg-red-100 focus:border-red-700 transition duration-150 ease-in-out'
