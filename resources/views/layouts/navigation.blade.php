<header class="bg-white">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8 shadow-small" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-7">
      <a href="{{url('home')}}" class="text-sm flex font-semibold text-navbar leading-6">Inicio</a>
      <div class="relative">
        <button type="button" class="flex items-center gap-x-1 text-navbar leading-6 text-gray-900" aria-expanded="false" id="btn-dropdown">
        Oferta educativa
    ...
    <div class="hidden lg:block mx-10 w-96">
      <form>   
