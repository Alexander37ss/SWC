...
<br><br>
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="text-sm font-normal text-gray-500 lex dark:text-gray-300">Thomas Lean <span class="bg-yellow-200 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Profesor</span> hizo un comentario <a href="#" class="font-semibold text-gray-900 dark:text-white hover:underline"></a></div>
            <div class="ml-auto">
                <time class="mb-1 text-xs font-normal text-gray-400 sm:order-last sm:mb-0">Hace 2 horas</time>
            </div>
            </div>
            <div class="p-3 italic font-medium border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300">Ya subí la tarea a la plataforma jovenes, para que la chequen.</div>
...
<section class="bg-white dark:bg-gray-900 py-8 lg:py-16">
  <div class="px-4">
      <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">Comentarios (20)</h2>
        <button type="submit"
